...
export class EchartsService {
  ...
  piePatternImg = new Image();
  bgPatternImg = new Image();
  chartData = [];

  //Global
  pieChartOptionGlobal: any = {
    title: {
      // Hiển thị tên của chart
      text: 'chartTitle',
    ...
    tooltip: {
      // Hiển thị thông tin của item khi hover chuột lên data.
      trigger: 'item',
    },
    ...
    series: [
      {
        ...
        emphasis: {
          // Hiệu hứng khi hover chuột lên chart data
          // itemStyle: {
          // 	shadowBlur: 10,
          // 	shadowOffsetX: 0,
        ...
        labelLine: {
          // Đường kẻ cho data label với data chart.
          lineStyle: {
            color: lib.getCssVariableValue('--ion-color-primary'),
          },
          smooth: 0.2,
        ...
        itemStyle: {
          // Màu nền cho dữ liệu chart
          color: lib.getCssVariableValue('--ion-color-tint'),
          // shadowBlur: 200,
          // shadowColor: 'rgba(0, 0, 0, 0.2)'
  ...
  textureOnPieChartOpt: any = {
    backgroundColor: {
      image: this.setImageSouce(this.bgPatternImg, this.pieSource.bgPatternSrc),
      repeat: 'repeat',
    },
    series: [
      {
        ...
        itemStyle: {
          ...
          opacity: 0.7,
          color: {
            image: this.setImageSouce(this.piePatternImg, this.pieSource.piePatternSrc),
            repeat: 'repeat',
          },
          borderWidth: 3,
          borderColor: '#235894',
    ...
    series: [
      {
        ...
        // itemStyle: { // Màu nền cho dữ liệu chart
        //     color: lib.getCssVariableValue('--ion-color-primary'),
        // },
    ...
    series: [
      {
        ...
        // emphasis: { // Hiệu hứng khi hover chuột lên chart data
        //     // itemStyle: {
        //     // 	shadowBlur: 10,
        //     // 	shadowOffsetX: 0,
        //     // 	shadowColor: 'rgba(0, 0, 0, 0.2)',
  ...
  setImageSouce(img: any, source) {
    img.src = source;
    return img;
  }

  //Global
  treeChartOptionGlobal: any = {
    title: {
      // Hiển thị tên của chart
      text: 'chartTitle',
      subtext: 'chartSubtext',
